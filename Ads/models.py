...
class Image(models.Model):
    image = models.CharField(max_length=255, default='')
    car = models.ForeignKey(Ads,default='', related_name='images', max_length=255, on_delete=models.CASCADE)
    
    
class Price(models.Model):
    amount = models.CharField(max_length=255, default='')
    date = models.DateField((""),auto_now_add=True)
    ads = models.ForeignKey(Ads, default='', related_name='price', max_length=255, on_delete=models.CASCADE)